...
<table class="table table-bordered">
    ...
    <tbody>
        <tr>
            <td>Delay Between Rotation (in seconds; e.g. 3.5)</td>
            <td><?php echo $formHelper->text($templateHelper->field('delay'), FlexryBlockTemplateOptions::valueOrDefault($templateHelper->value('delay'), '3.5')); ?></td>
        </tr>
        <tr>
